...
To make a deposit user generates a secret and sends its hash (called a commitment) along with the deposit amount to the Ajax smart contract. The contract accepts the deposit and adds the commitment to its list of deposits.
...
Ajax uses a Tornado.cash base protocols, circuits, and smart contracts were audited by a group of experts from [ABDK Consulting](https://www.abdk.consulting), specializing in zero-knowledge, cryptography, and smart contracts.
...
1. Please use https://github.com/fernandocfjr/ajax-cli
   Reason: because ajax-core uses websnark `commitHash_tbd` commit hash in order to work with local trusted setup. Ajax-cli uses `commitHash_tbd` commit with production trusted setup.

Example:

```bash
./cli.js deposit ETH 0.1 --rpc https://goerli.infura.io/v3/123456789abcdef
```

> Your note: ajax-eth-0.1-42-0xf73dd6833ccbcc046c44228c8e2aa312bf49e08389dadc7c65e6a73239867b7ef49c705c4db227e2fadd8489a494b6880bdcb6016047e019d1abec1c7652
> Ajax ETH balance is 8.9
> Sender account ETH balance is 1004873.470619891361352542
> Submitting deposit transaction
> Ajax ETH balance is 9
> Sender account ETH balance is 1004873.361652048361352542

```bash
./cli.js withdraw ajax-eth-0.1-42-0xf73dd6833ccbcc046c44228c8e2aa312bf49e08389dadc7c65e6a73239867b7ef49c705c4db227e2fadd8489a494b6880bdcb6016047e019d1abec1c7652 0x8589427373D6D84E98730D7795D8f6f8731FDA16 --rpc https://goerli.infura.io/v3/27a9649f826b4e31a83e07ae09a87448 --relayer https://goerli-frelay.duckdns.org
```

> Relay address: 0xXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
> Getting current state from ajax contract
> Generating SNARK proof
> Proof time: 9117.051ms
> Sending withdraw transaction through the relay
> Transaction submitted through the relay. View transaction on etherscan https://goerli.etherscan.io/tx/txhash
> Transaction mined in block xxxxxxx
> Done
